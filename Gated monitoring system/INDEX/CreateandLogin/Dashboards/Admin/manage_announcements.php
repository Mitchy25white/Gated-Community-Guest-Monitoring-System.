...
$query = "SELECT * FROM manage_announcement ORDER BY created_at DESC";
...
<head>
    ...
    body {
        ...
        .view:active {
            background: #7d3c98; /* Even darker purple on click */
        }
        .view:focus {
            outline: none;
        }
...
<body>
    ...
    <div class="report-container">
        <div class="report-header">
            ...
            <button class="view" onclick="location.href='add_announcement.php'">Create New</button>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="view_announcement.php?id=<?= $announcement['id'] ?>">View</a>
                            <a href="edit_announcement.php?id=<?= $announcement['id'] ?>">Edit</a>
                            <a href="delete_announcement.php?id=<?= $announcement['id'] ?>">Delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
